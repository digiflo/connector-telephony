...
import {Call} from "@voip_freepbx/components/call/call.esm";
import {Numpad} from "@voip_freepbx/components/numpad/numpad.esm";
import {Partner} from "@voip_freepbx/components/partner/partner.esm";
...
export class VoipOCASoftphone extends Component {
    setup() {
        this.voip = useState(useService("voip_freepbx"));
...
VoipOCASoftphone.template = "voip_freepbx.VoipOCASoftphone";

registry.category("main_components").add("voip_freepbx.VoipOCASoftphone", {
